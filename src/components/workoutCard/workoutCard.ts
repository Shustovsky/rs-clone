...
export class WorkoutCard {
    ...
    public render(workout: Workout): void {
        ...
        card.innerHTML = `<div class='workouts__card uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light' data-src='${workout.coverImageUrl}' uk-img='loading: eager'>
